...
class MyTierListsScreen extends StatelessWidget {
  const MyTierListsScreen({super.key});

  static const String routeName = '/mytierlists';
        ...
        builder: (context, provider, child) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return TierListCard(tierList: tierList);
            },
          );
        },
      ),
